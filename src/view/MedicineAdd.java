...
public class MedicineAdd extends JDialog implements MyView{
	...
	/**
	 * Méthode statique permettant d'obtenir la sélection de la liste déroulante effets
	 * @return la selection de la liste déroulante effets
	 */
	...
	public MedicineAdd(String[] forms, String[] effets) {
		...
		lblEffet.setBounds(20, 160, 70, 14);
